...
// ── ANALYTICS SECTION ──────────────────────────────────────────────
/**
 * AnalyticsSection is memoized to prevent re-renders on every clock tick (once per second).
 * We also use useMemo for expensive data transformations to ensure reference stability
 * for the Recharts components, which are computationally expensive to re-render.
 * Expected Impact: Reduces re-renders from ~60/min to only on data change.
 */
