...
// ── QUIT COUNTER CARD ─────────────────────────────────────────────
const QuitCounterCard = React.memo(function QuitCounterCard({ quitDate, setQuitDate, smokeStats }: {
  quitDate: string;
...
// ── AI MOTIVATION CARD ────────────────────────────────────────────
const AIMotivationCard = React.memo(function AIMotivationCard({ settings, smokeStats, gymStreak, completionPct, goals }: {
  settings: Settings;
  smokeStats: SmokeStats;
  gymStreak: number;
...
const AIChatController = React.memo(function AIChatController({
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      ...
      <main style={{ marginLeft: 72, flex: 1, padding: 32, maxWidth: 'calc(100vw - 72px)', minWidth: 0 }}>
        ...
        {activeNav === 'planner' && <PlannerSection addTask={addTask} notify={notify} aiSchedule={aiSchedule} setAiSchedule={setAiSchedule} dailyDate={now} />}
