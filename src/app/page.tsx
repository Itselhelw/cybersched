...
export default function Dashboard() {
  ...
  const {
    tasks, todayTasks, habits, habitsWithProgress,
  ...
  // Gamification calculations - memoized to prevent O(N) recalc every second
  ...
  // Memoize week dates to only update when the day changes, not every second
