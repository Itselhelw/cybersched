...
const PlannerSection = memo(function PlannerSection({ addTask, notify, aiSchedule, setAiSchedule, dailyDate }: {
  ...
  const now = dailyDate ? new Date(dailyDate) : null;
...
export default function Dashboard() {
  ...
  const {
    ...
    addTask, completeTask, toggleHabit, notify, dailyDate
  } = app;
  ...
  const weekDates = useMemo(() => getWeekDates(dailyDate ? new Date(dailyDate) : null), [dailyDate]);
