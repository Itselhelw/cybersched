...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize high-frequency calculations to prevent redundant O(N) work every second
  ...
  // Only recalculate week dates when the current day changes, not every second
