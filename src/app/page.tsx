...
// ── TASKS SECTION ─────────────────────────────────────────────────
/**
 * Optimized TasksSection using React.memo to prevent unnecessary re-renders when the global clock ticks.
 * It only re-renders when tasks or the current date string change.
 */
...
// ── HABITS SECTION ────────────────────────────────────────────────
/**
 * Optimized HabitsSection using React.memo.
 * It only re-renders when habits with their progress change.
 */
...
// ── STATS SECTION ─────────────────────────────────────────────────
/**
 * Optimized StatsSection using React.memo.
 */
...
// ── ANALYTICS SECTION ──────────────────────────────────────────────
/**
 * Optimized AnalyticsSection using React.memo.
 */
...
// ── PLANNER SECTION ───────────────────────────────────────────────
/**
 * Optimized PlannerSection using React.memo to prevent per-second re-renders from the main dashboard clock.
 * It only re-renders when tasks, AI schedule, or the current day change.
 */
...
// ── GERMAN SECTION ────────────────────────────────────────────────
/**
 * Optimized GermanSection using React.memo.
 */
...
// ── SETTINGS SECTION ──────────────────────────────────────────────
/**
 * Optimized SettingsSection using React.memo.
 */
...
// ── POMODORO TIMER ────────────────────────────────────────────────
/**
 * Optimized PomodoroTimer using React.memo.
 */
...
/**
 * Optimized CyberSection using React.memo.
 */
...
export default function Dashboard() {
  ...
  // Gamification calculations - memoized to provide stable props to memoized child components
  ...
  // Stable daily date to prevent re-renders of components that only need day-level accuracy
  const dailyDate = useMemo(() => now ? new Date(now.getFullYear(), now.getMonth(), now.getDate()) : null, [currentTodayStr]);
