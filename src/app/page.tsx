...
export default function Dashboard() {
  ...
  // Stabilize date dependencies to prevent redundant per-second re-renders
  const dailyDate = useMemo(() => {
    if (!now) return null;
    return new Date(now.getFullYear(), now.getMonth(), now.getDate());
  }, [now?.toDateString()]);

  const stableCurrentTodayStr = useMemo(() => {
    return todayStr(dailyDate);
  }, [dailyDate]);
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      ...
      <main style={{ marginLeft: 72, flex: 1, padding: 32, maxWidth: 'calc(100vw - 72px)', minWidth: 0 }}>
            ...
            <div className="content-grid">
              <div className="content-left">
                ...
                <div className="card">
                  ...
                  {tasks.filter((t: any) => t.date === stableCurrentTodayStr || (stableCurrentTodayStr === '' && t.date === '')).sort((a: any, b: any) => a.time.localeCompare(b.time)).map((task: any) => (
        ...
        {activeNav === 'tasks' && <TasksSection tasks={tasks} setTasks={app.setTasksRaw} currentTodayStr={stableCurrentTodayStr} />}
      ...
      <AIChatController
        ...
        currentTodayStr={stableCurrentTodayStr}
        notify={notify}
        addTask={addTask}
