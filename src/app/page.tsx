...
const AnalyticsSection = memo(function AnalyticsSection({ tasks, habits, settings, smokeStats }: { tasks: Task[]; habits: Habit[]; settings: Settings; smokeStats: SmokeStats }) {
  ...
  // Memoize analytics computations to prevent O(N) recalculations on every re-render
  // This is especially important as smokeStats updates every minute, triggering re-renders
