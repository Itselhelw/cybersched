...
const PlannerSection = memo(function PlannerSection({
  addTask, notify, aiSchedule, setAiSchedule, now, weekDates
}: {
...
export default function Dashboard() {
  ...
  // Gamification calculations - memoized to prevent expensive O(N) recalculations 60 times/min
  ...
  // Derive week dates only when the day changes
