...
/**
 * WeeklyProgressChart: Visualizes task completion progress over 7 days.
...
/**
 * CategoryBreakdownChart: Shows completion status by life category.
 * Wrapped in memo to prevent redundant re-renders from the dashboard's per-second clock.
 */
...
/**
 * StreakRanking: Ranks habits by their current streak.
 * Wrapped in memo to prevent redundant re-renders from the dashboard's per-second clock.
 */
  ...
  return (
    <div className="card" style={{ padding: 20, marginBottom: 20 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {/* Clone data before sorting to avoid in-place mutation of props */}
        {[...data]
...
/**
 * CompletionDonut: Overall task completion percentage in a donut chart.
 * Wrapped in memo to prevent redundant re-renders from the dashboard's per-second clock.
 */
