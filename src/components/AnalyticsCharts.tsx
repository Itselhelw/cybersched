...
/**
 * Memoized to prevent expensive chart re-renders when the dashboard clock ticks.
 * Re-renders only when the weekly data actually changes.
 */
...
/**
 * Memoized to prevent list re-sorting on every second.
 */
...
/**
 * Memoized to stabilize the main dashboard overview.
 */
