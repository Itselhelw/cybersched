...
/**
 * Memoized to prevent expensive re-renders when the dashboard clock updates every second.
 * Re-renders only when the 'data' prop changes.
 */
...
/**
 * Memoized to prevent expensive re-renders when the dashboard clock updates every second.
 * Clones data before sorting to avoid mutating props and maintain reference stability.
 */
...
/**
 * Memoized to prevent expensive re-renders when the dashboard clock updates every second.
 * Re-renders only when the 'stats' prop changes.
 */
