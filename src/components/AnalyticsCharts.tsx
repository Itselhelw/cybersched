...
/**
 * ⚡ Performance Optimization: Wrap visualization components in React.memo
 * to prevent expensive chart re-renders when the global application clock updates
 * every second. Charts only need to re-render when their underlying data changes.
 */
  ...
  return (
    <div className="card" style={{ padding: 20, marginBottom: 20 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {/* ⚡ Optimization: Clone the array before sorting to avoid mutating props,
            which can lead to unpredictable UI behavior and break memoization. */}
        {[...data]
