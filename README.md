...
Tech Stack
LayerTechnologyFrameworkNext.js 14 (App Router)LanguageTypeScriptStylingTailwind CSS + Custom CSS VariablesAI ProviderGroq API — Llama 3.1 8B InstantData StorageBrowser localStoragePDF ExportjsPDFDeploymentVercelVersion ControlGitHub
Getting Started
bashgit clone https://github.com/Itselhelw/cybersched.git
cd cybersched
npm install
